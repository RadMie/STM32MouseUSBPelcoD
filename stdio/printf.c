 ...
 * @param  c    Character to write.
 */
signed int PutChar1(char *pStr, char c)
{
    *pStr = c;
    return 1;
}
    ...
    signed int value)
{
    ...
    /* Write lower digit */
    num += PutChar1(pStr, (absolute % 10) + '0');
    ...
    unsigned int value)
{
    ...
    if ((value & 0xF) < 10) {
        ...
        PutChar1(pStr, (value & 0xF) + '0');
    }
    else if (maj) {

        PutChar1(pStr, (value & 0xF) - 10 + 'A');
    }
    else {
...
signed int vsnprintf(char *pStr, size_t length, const char *pFormat, va_list ap)
{
    ...
    while (*pFormat != 0 && size < length) {
        ...
        /* Token delimiter */
            ...
            case 'c': num = PutChar1(pStr, va_arg(ap, unsigned int)); break;
            default:
                return EOF;
            }
